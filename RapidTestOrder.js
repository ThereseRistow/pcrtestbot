  ...
  constructor(sFrom) {
    this.OrderState = {
      WELCOMING: () => {
        ...
        aReturn.push("Welcome to Malivoire.");
        aReturn.push("Would you like to reserve a wine tasting?");
        return aReturn;
      }
      RESERVING: (sInput) => {
        let aReturn = [];
        ...
        if (sInput.toLowerCase().startsWith('y')) {
          aReturn.push(`Your reservation is reserved under the phone number ${this.sFrom}`);
          let d = new Date();
